...
async function createListing(walletAddress, tokenId, listingAmount, ownerId, provider) {
    ...
    try {
        ...
        owners["storing"][ownerId]["listingNFT"]["amount"]++
        owners["storing"][ownerId]["listingNFT"]["tokenIds"].push(tokenId)
