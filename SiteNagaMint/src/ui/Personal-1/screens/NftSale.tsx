...
const WhiteListScreen = () => {
  ...
  return (
    <section className={`whitelist ${currentScreen === 'hero' && 'active'}`} id="js--whitelist-window">

      {/* <!-- Верхний блок страницы с заголовком и расой --> */}
      <div className="whitelist__top">
        <h2 className="whitelist__title" id="js--whitelist-title">NFT PRESALE</h2>
        <span className="whitelist__race">GAME PASS</span>
      </div>
        ...
        <div className="whitelist__top-mobile">
          <div className="whitelist__top-mobile-sale-wrapper">
            ...
            <ul className="whitelist__top-mobile-sale-list">
              <li className='soldout'>Presale 1</li>
              <li className="active">Presale 2</li>
              <li>Presale 3</li>
              <li>Presale 3</li>
              <li>Public sale</li>
            </ul>
      ...
      <div className="whitelist__main">
        ...
        <ul className="whitelist__main-buttons-list">
          <li className="whitelist__main-buttons-item">
            <button className="whitelist__main-buttons-button gray">
              <picture><img src="img/dark-elf.png" alt="" /></picture>
              <span>Presale 1</span>
              <span className='soldout'>soldout</span>
            </button>
          </li>
          <li className="whitelist__main-buttons-item">
            <button onClick={setActiveInvestWindow}
              className={`whitelist__main-buttons-button ${activeWindow === 'invest' && 'active'}`}
            >
              <picture><img src="img/dark-elf.png" alt="" /></picture>
              <span>Presale 2</span>
            </button>
