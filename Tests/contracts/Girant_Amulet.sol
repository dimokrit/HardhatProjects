...
contract Girand_Amulet is  Ownable, ReentrancyGuard, ERC2981, ERC721A {
    ...
    constructor(string memory baseURI, string memory name, string memory symbol, uint96 royalty) ERC721A(name, symbol) {
    ...
    */
    ...
    ///@param _merkleRoot is new root of merkle tree
